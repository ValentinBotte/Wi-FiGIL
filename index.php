...
<body>
  ...
  <div class="container">
    ...
    <div class="center-align">
      <div class="containGhost container">
        <svg class="ghost" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        width="127.433px" height="132.743px"
        xml:space="preserve">
        <path fill="white" d="M116.223,125.064c1.032-1.183,1.323-2.73,1.391-3.747V54.76c0,0-4.625-34.875-36.125-44.375
        ...
        <circle fill="#013E51"  cx="18.614" cy="99.426" r="3.292"/>
        <circle fill="#013E51" cx="95.364" cy="28.676" r="3.291"/>
        <circle fill="#013E51"  cx="24.739" cy="93.551" r="2.667"/>
        <circle fill="#013E51"  cx="101.489" cy="33.051" r="2.666"/>
        <circle fill="#013E51"  cx="18.738" cy="87.717" r="2.833"/>
        <path fill="#013E51"  d="M116.279,55.814c-0.021-0.286-2.323-28.744-30.221-41.012
